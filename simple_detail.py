...
def SimpleDetail(url):
    ...
    Example1)사이즈 옵션은 총 3가지로 S, M, L이 있습니다. 상품은 10/7(토) 도착 예정입니다. 가장 유용한 리뷰: 164cm/49kg 여성이 M 사이즈를 구매했으며, 적당한 오버핏으로 길이도 키에 딱 맞아서 편하고 예쁘고 후드티 핏이 좋다고 리뷰를 남겼습니다.
    Example2)사이즈 옵션은 총 2가지로 M, L이 있습니다. 상품은 10/6(금) 도착 예정입니다. 가장 유용한 리뷰: 162cm/53kg 여성이 L 사이즈를 구매했으며, 품과 길이가 모두 만족스럽다고 리뷰를 남겼습니다.
